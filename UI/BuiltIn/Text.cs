    ...
    public class Text : Component
    {
        ...
        public override void UpdateProperties()
        {
            ...
            if (_previousPosition != Position) {
                ...
                if (HasParent && Parent!.PositionSubcomponents) {ActualPosition = Parent.ActualPosition + Position.ToVector2(Parent.ActualPosition) - new Vector2(TextBoundsSize.X * Origin.X, TextBoundsSize.Y * Origin.Y);}
